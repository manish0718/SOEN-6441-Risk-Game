 ...
 */
class ContinentsConnectedConquest {
     ...
     */
    public ContinentsConnectedConquest(File p_file) {
    ...
    public boolean ifContinentsConnected() throws Exception {
        ...
        MapTableConquest l_obj = new MapTableConquest();
        ArrayList<Integer> l_ContinentAndKey = l_obj.continentsKeyConquest(d_file);
        ArrayList<Integer> l_ContId = l_obj.CountriesContinentConquest(d_file);
        Collections.sort(l_ContId);
        GraphConnectedConquest l_check = new GraphConnectedConquest(d_file);
    ...
    public HashMap<Integer,ArrayList> ifContinentCountriesConnected() throws Exception {
        ...
        HashMap<Integer,Integer> l_connect = l_obj.contConquest(d_file);
        ArrayList<Integer> l_ContinentAndKey = l_obj.continentsKeyConquest(d_file);
